...
When DEVIN_REPLAY=1, seeds the database with demo data on startup.
"""
...
IS_REPLAY = os.getenv("DEVIN_REPLAY", "").strip() == "1"
...
_DEMO_FINDINGS = [
    {
        ...
        "raw_details": json.dumps({"cve": "CVE-2023-48795", "package": "paramiko"}),
    },
    {
        ...
        "raw_details": json.dumps({"cve": "CVE-2022-29217", "package": "PyJWT"}),
    },
    {
        ...
        "raw_details": json.dumps({"rule_id": "hive-column-injection"}),
    },
    {
        ...
        "raw_details": json.dumps({"package": "apispec", "installed_version": "6.6.1"}),
    },
    {
        ...
        "raw_details": json.dumps({"package": "dompurify", "installed_version": "3.0.6"}),
    },
    {
        ...
        "raw_details": json.dumps({"rule_id": "cancel-query-sql-injection"}),
    },
    {
        ...
        "raw_details": json.dumps({"rule_id": "yaml-unsafe-loader"}),
    },
    {
        ...
        "raw_details": json.dumps({"rule_id": "silenced-exceptions"}),
    },
]

_DEMO_SESSIONS = [
    {
        "devin_session_id": "befca461b63742158484c89b67c6759a",
        "finding_id": "finding-paramiko-001",
        "devin_url": "https://app.devin.ai/sessions/befca461b63742158484c89b67c6759a",
        "status": "exit",
    ...
    {
        "devin_session_id": "3400ce3f06e5437abc3542398413f70a",
        "finding_id": "finding-pyjwt-001",
        "devin_url": "https://app.devin.ai/sessions/3400ce3f06e5437abc3542398413f70a",
        "status": "exit",
        "action_taken": "fixed",
    ...
    {
        "devin_session_id": "3ddc8ec86ff74406bb14630e9700cdb0",
        "finding_id": "finding-hive-injection-001",
        "devin_url": "https://app.devin.ai/sessions/3ddc8ec86ff74406bb14630e9700cdb0",
        "status": "exit",
        "action_taken": "fixed",
    ...
    {
        "devin_session_id": "66ddd3f04c8c4d57acc7f8e476a7b0e7",
        "finding_id": "finding-apispec-upgrade-001",
        "devin_url": "https://app.devin.ai/sessions/66ddd3f04c8c4d57acc7f8e476a7b0e7",
        "status": "exit",
        "action_taken": "fixed",
        "pr_url": "https://github.com/michaelszhu/superset/pull/44",
        "acus_consumed": 8.5,
        "created_at": "2026-06-22T12:00:00+00:00",
        "updated_at": "2026-06-22T12:20:00+00:00",
        "structured_output": json.dumps({
            "reasoning": "Bumped apispec to 6.7.1, updated test assertion.",
        }),
    },
    {
        "devin_session_id": "48b27654e29341508cb5ac88163e0816",
        "finding_id": "finding-dompurify-upgrade-001",
        "devin_url": "https://app.devin.ai/sessions/48b27654e29341508cb5ac88163e0816",
        "status": "exit",
        "action_taken": "fixed",
        "pr_url": "https://github.com/michaelszhu/superset/pull/45",
        "acus_consumed": 8.5,
        "created_at": "2026-06-22T12:30:00+00:00",
        "updated_at": "2026-06-22T12:50:00+00:00",
        "structured_output": json.dumps({
            "reasoning": "Bumped DOMPurify to 3.1.7 to resolve sanitizer-bypass advisory.",
        }),
    },
    {
        "devin_session_id": "8e39c6cb6d7849f4a4a74ad0e03d666f",
        "finding_id": "finding-cancel-query-sqli-001",
        "devin_url": "https://app.devin.ai/sessions/8e39c6cb6d7849f4a4a74ad0e03d666f",
        "status": "exit",
        ...
        "structured_output": json.dumps({
            "reasoning": "The f-string interpolates a pg_stat_activity.pid integer, not user input. No injection vector.",
        }),
    },
    {
        "devin_session_id": "871d5c3499824d7e8496f69775e67182",
        "finding_id": "finding-yaml-unsafe-loader-001",
        "devin_url": "https://app.devin.ai/sessions/871d5c3499824d7e8496f69775e67182",
        "status": "exit",
        "action_taken": "fixed",
        "pr_url": "https://github.com/michaelszhu/superset/pull/46",
        "acus_consumed": 8.5,
        "created_at": "2026-06-22T13:30:00+00:00",
        "updated_at": "2026-06-22T13:50:00+00:00",
        "structured_output": json.dumps({
            "reasoning": "Replaced yaml.Loader with yaml.SafeLoader in load_configs_from_directory().",
        }),
    },
    {
        "devin_session_id": "227d96874da0426cb5cdd73b21636790",
        "finding_id": "finding-silenced-exceptions-001",
        "devin_url": "https://app.devin.ai/sessions/227d96874da0426cb5cdd73b21636790",
        "status": "exit",
        "action_taken": "fixed",
        "pr_url": "https://github.com/michaelszhu/superset/pull/47",
        "acus_consumed": 8.5,
        "created_at": "2026-06-22T14:00:00+00:00",
        "updated_at": "2026-06-22T14:30:00+00:00",
        "structured_output": json.dumps({
            "reasoning": "Added logger.warning with exc_info=True to silenced exception handlers.",
        }),
    },
]
